...
#define STRING_CONFIG_H_AUTHOR "(Gregor Pfirter, default config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD 34  // == BOARD_RAMPS_13_EEB  // edited: 2 hotends + heating bed
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "GregsDelta"
...
// Horizontal offset from middle of printer to smooth rod center.
  ...
  // Horizontal distance bridged by diagonal push rods when effector is centered. More explanation here: https://reprap.org/forum/read.php?1,781167
  #define DELTA_RADIUS  (DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)//168.80 //mm  Get this value from auto calibrate
...
#define Z_MIN_ENDSTOP_INVERTING false  // set to true to invert the logic of the endstop.  ->Changed for BLTOUCH
...
// delta speeds must be the same on xyz
#define DEFAULT_XYZ_STEPS_PER_UNIT 55.35 // was ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 574 }  // default steps per unit for Kossel (GT2, 20 tooth)
